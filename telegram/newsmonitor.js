...
فقط با حروف فارسی بنویس و در صورت نیاز انگلیسی (برای نام‌ها). هیچ حرف چینی یا ژاپنی یا کره‌ای یا هر خط و الفبای دیگری به‌کار نبر، حتی یک کلمه یا یک نویسه.
